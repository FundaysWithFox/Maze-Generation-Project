...
if cells_visited < maze_width * maze_height
{
	...
	if y_pos > 0
	{
		...
		if irandom(1) && x_pos < maze_width - 1
		{
			...
			maze_status[array_get_coord(x_pos, y_pos, maze_width)][cell.CELL_PATH_EAST] = true;
			maze_status[array_get_coord(x_pos + 1, y_pos, maze_width)][cell.CELL_PATH_WEST] = true;
			maze_status[array_get_coord(x_pos + 1, y_pos, maze_width)][cell.CELL_VISITED] = true;
		...
		else
		{
			...
			maze_status[array_get_coord(cell_choice[0], cell_choice[1], maze_width)][cell.CELL_PATH_NORTH] = true;
			maze_status[array_get_coord(cell_choice[0], cell_choice[1] - 1, maze_width)][cell.CELL_PATH_SOUTH] = true;
	...
	else if x_pos < maze_width - 1
	{
		...
		maze_status[x_pos][cell.CELL_PATH_EAST] = true;
		maze_status[x_pos + 1][cell.CELL_PATH_WEST] = true;
		maze_status[x_pos + 1][cell.CELL_VISITED] = true;
	}
